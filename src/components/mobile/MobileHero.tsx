...
const MobileHero = () => {
  return (
    ...
    <div className='lg:hidden relative  h-full  gap-4  mt-10 px-6 bg-img-m'>
        <img src={heroImage} alt="" className='w-full relative  h-96 md:h-[45rem]' />
    ...
    <div className='lg:hidden flex flex-col gap-4 px-4'>
        ...
        <p className='text-lg text-[#5f5e5e] text-left'>Chronicle is a modern format of presentations. Deliver impressive, interactive stories without the design guesswork!</p>
    </div>
    <div className='w-full px-4'>
        <button className='text-center text-black font-bold bg-white py-2 w-full rounded-xl'>Join Beta</button>
    </div>
</section>
  )
}
